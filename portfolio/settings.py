...
print(f"Raw ALLOWED_HOSTS from environment: {raw_allowed_hosts}")  # Debug adicional
ALLOWED_HOSTS = raw_allowed_hosts.replace(" ", "").replace("=", "").split(",")
print(f"Processed ALLOWED_HOSTS: {ALLOWED_HOSTS}")  # Debug procesado
